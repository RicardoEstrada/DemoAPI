...
class BeerRepository() {
    ...
    suspend fun getBeers(page: Int, pageSize: Int, onSuccess: (List<BeerData>) -> Unit, onError: (String) -> Unit) {
        val connector: WSConnector = WSConnector()
        val apiIntercafe = connector.retrofitHelper.create(BeerApi::class.java).getBeers(page, pageSize)
